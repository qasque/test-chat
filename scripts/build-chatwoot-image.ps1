...
Write-Host "In test-chat repo, edit docker-compose.yml — у сервиса base / image:"
Write-Host "  image: $fullTag"
Write-Host "Файл называется docker-compose.yml (не docker-compose.production.yaml — его в test-chat нет)."
Write-Host "Then:"
